...
May output files are created for different categories and different years that we used for data exploration.
In future work we would refactor this code to make it faster and store information in memory instead of parsing to files.
